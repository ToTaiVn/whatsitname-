...
function Update:Window(text,logo,keybind)
	...
	Main.BackgroundColor3 = Color3.fromRGB(45, 51, 97)
...
Logo.Image = "rbxassetid://14822183310"
...
local postog = Instance.new("UIStroke")
 ...
 TabImage.Image = "rbxassetid://14822183310"
...
local postog12 = Instance.new("UIStroke")
 ...
 ImageLabel.Image = "rbxassetid://14822183310"
 ...
 ImageButton.Image = "rbxassetid://14822183310"
...
function main:Dropdown(text,option,callback)
 ...
 DropImage.Image = "rbxassetid://14822183310"
    ...
    function InfAb()
        if InfAbility then
            if not game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
                ...
                inf.Texture = "rbxassetid://14822183310"
...
wait(1)
Notification:Notify(
   {Title = "Strange Hub Info ", Description = "You Have Max Observation"},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "http://www.roblox.com/asset/?id=14822183310", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
                    else
                        if World2 then
